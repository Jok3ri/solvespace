...
function main() {
  ...
  const traceScopeExpanded = curr.traceSession.total > prev.traceSession.total;
  if (!traceScopeExpanded && curr.traceSession.pending > prev.traceSession.pending) {
    failures.push('trace pending count increased without trace-scope expansion');
  }
