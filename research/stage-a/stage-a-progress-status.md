...
2. Expand topology invariant checks beyond initial trim continuity coverage.
...
Add topology invariants for extend/chamfer/fillet output continuity and endpoint consistency.
