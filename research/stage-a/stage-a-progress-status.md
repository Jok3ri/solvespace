...
3. Expand offset fixture family from current simple/corner/self-intersection detection to richer geometry variants.
...
Add richer executable corner offset variants (directionality and non-axis-aligned cases).
