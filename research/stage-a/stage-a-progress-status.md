...
3. Expand offset fixture family from simple + corner support to self-intersection/corner variants.
...
Add executable offset self-intersection behavior checks (beyond current unsupported diagnostics).
